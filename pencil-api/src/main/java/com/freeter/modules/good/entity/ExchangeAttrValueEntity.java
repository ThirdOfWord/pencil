 ...
 */
@TableName("cd_exchange_attr_value")
@ApiModel(value = "ExchangeAttrValue")
public class ExchangeAttrValueEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public ExchangeAttrValueEntity() {
		
	}
	
	public ExchangeAttrValueEntity(T t) {
		try {
