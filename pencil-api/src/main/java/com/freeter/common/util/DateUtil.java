...
public class DateUtil {
    ...
    //当前时间的前一小时
    public static String hoursDate() {
    ...
    public static String minuteDate() {
        Calendar calendar = Calendar.getInstance();
        /* HOUR_OF_DAY 指示一天中的小时 */
        calendar.set(Calendar.MINUTE, calendar.get(Calendar.MINUTE) - 7);
        SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        String dateString = df.format(calendar.getTime());
        return dateString;
    }
    //当前时间的前2分钟
    public static String beforeTwoDate() {
        Calendar calendar = Calendar.getInstance();
        /* HOUR_OF_DAY 指示一天中的小时 */
    ...
    //当前时间的前4分钟
    public static String beforeSiDate() {
        Calendar calendar = Calendar.getInstance();
        /* HOUR_OF_DAY 指示一天中的小时 */
    ...
    //打印当前日期 精确到分
    public static String printDateMm() {
        Date currentTime = new Date();
    ...
    //打印当前日期 精确到时
    public static String printDateHh() {
        Date currentTime = new Date();
