 ...
 * @copyright CopyRight (C) 2019 HZCM All Rights Reserved
 * @version 1.0 
...
public class SMSUtil
{
	...
	private static String sOpenUrl = "http://apis.hzfacaiyu.com/sms/";
	private static String sDataUrl = "http://apis.hzfacaiyu.com/sms/";
